...
intent_metadata:
  schema_version: 1
  fixture: text_maxlength_a8_74p60mm.txt
  ...
  experimental_rationale: >-
    Critical discriminator between a possible natural-length transition and a possible scalar/clamp transition; future hypotheses only.
```

[Raw fixture](../../text/text_maxlength_a8_74p60mm.txt) ·
