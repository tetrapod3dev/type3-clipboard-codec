...
intent_metadata:
  schema_version: 1
  fixture: text_maxlength_a8_40mm.txt
  ...
  baseline_value_mm: 0
  changed_value_mm: 40
  expected_ui_relationship: well_below_natural_length
  observed_program_behavior: >-
    text is compressed more strongly than at 60 mm
  ...
  experimental_rationale: >-
    Compare a second below-natural requested length with 60 mm; stronger compression is descriptive intent, not a binary oracle.
```

[Raw fixture](../../text/text_maxlength_a8_40mm.txt) ·
