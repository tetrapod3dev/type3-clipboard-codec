# text_slotstyle_a8_all_spacing150
...
intent_metadata:
  schema_version: 1
  fixture: text_slotstyle_a8_all_spacing150.txt
  ...
  font: Arial
  character_count: 8
  changed_scope: all_visible_characters
  target_character_indices_1based: [1, 2, 3, 4, 5, 6, 7, 8]
  ...
  experimental_rationale: >-
    Compare single-character and all-visible-character application; later ask whether a candidate field repeats across all eight visible slots.
```

[Raw fixture](../../text/text_slotstyle_a8_all_spacing150.txt) ·
