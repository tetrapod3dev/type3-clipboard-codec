...
intent_metadata:
  schema_version: 1
  fixture: text_maxlength_a8_74p66mm.txt
  ...
  relationship_to_exact_natural_extent: above
  relationship_to_provisional_crossover: above
  ...
  experimental_rationale: >-
    Probe immediately beyond the provisional scalar crossover without predicting a binary outcome.
```

[Raw fixture](../../text/text_maxlength_a8_74p66mm.txt) ·
