...
intent_metadata:
  schema_version: 1
  fixture: text_maxlength_a8_60mm.txt
  ...
  baseline_value_mm: 0
  changed_value_mm: 60
  expected_ui_relationship: less_than_natural_length
  observed_program_behavior: >-
    text is compressed horizontally to fit the specified maximum length
  ...
  experimental_rationale: >-
    Compare a below-natural requested length with 40 mm; distinguish a future stored requested value from derived compression/layout changes.
```

[Raw fixture](../../text/text_maxlength_a8_60mm.txt) ·
