# text_slotstyle_a8_char4_spacing150
...
intent_metadata:
  schema_version: 1
  fixture: text_slotstyle_a8_char4_spacing150.txt
  ...
  experimental_rationale: >-
    Compare a high character-spacing setting against the 100% baseline without assuming an encoding.
```

[Raw fixture](../../text/text_slotstyle_a8_char4_spacing150.txt) ·
