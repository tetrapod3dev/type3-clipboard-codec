...
intent_metadata:
  schema_version: 1
  fixture: text_maxlength_a8_m60mm.txt
  ...
  baseline_value_mm: 0
  changed_value_mm: -60
  expected_ui_relationship: negative
  observed_program_behavior: >-
    text is displayed in the program's negative-length inverted/reflected form, observed downward
  ...
  experimental_rationale: >-
    Compare positive and negative maximum-length UI behavior; future sign/reflection-related localization must not assume an encoding.
```

[Raw fixture](../../text/text_maxlength_a8_m60mm.txt) ·
