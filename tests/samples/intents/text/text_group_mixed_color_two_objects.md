...
- category: text
- fixture: `tests/samples/text/text_group_mixed_color_two_objects.txt`
- selected/copied object count: 2
- grouped/not grouped: grouped
- description: Two text objects combined with Type3 `결합`, with Army Green and Navy Blue colors.
