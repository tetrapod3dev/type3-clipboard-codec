...
intent_metadata:
  schema_version: 1
  fixture: text_maxlength_a8_74p58mm.txt
  ...
  experimental_rationale: >-
    Sample immediately below the exact natural-length boundary.
```

[Raw fixture](../../text/text_maxlength_a8_74p58mm.txt) ·
