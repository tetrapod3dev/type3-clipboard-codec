# text_slotstyle_a8_char4_spacing50
...
intent_metadata:
  schema_version: 1
  fixture: text_slotstyle_a8_char4_spacing50.txt
  ...
  experimental_rationale: >-
    Compare a low character-spacing setting against the 100% baseline; future numeric representation remains unassigned.
```

[Raw fixture](../../text/text_slotstyle_a8_char4_spacing50.txt) ·
